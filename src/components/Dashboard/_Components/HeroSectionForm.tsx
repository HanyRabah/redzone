...
export default function HeroSliderForm({
  ...
  useEffect(() => {
    const isDataChanged =
      JSON.stringify(slides) !== JSON.stringify(initialData?.slides);
  ...
  return (
    <Card sx={{ mx: "auto" }}>
      <CardHeader
        title={
          <Box sx={{ m: 1 }}>
            <Typography variant="h4" sx={{  fontWeight: 600 }}> Hero Slider </Typography>
            <Typography variant="caption" sx={{ color: "text.secondary" }}>
              Configure hero slider with multiple slides and animations
            </Typography>
          </Box>
        }
      />
      <CardContent>
        <Box component="form" onSubmit={handleSubmit}>
          <Stack spacing={2} direction="row">
            {/* Slides Overview */}
            <Card sx={{ width: "75%", borderRadius: 3, overflow: "hidden" }}>
              <CardHeader
                sx={{
                    ...
                    {slides.map((slide, index) => {
                      ...
                      return (
                        <Accordion
                          ...
                          sx={{
                            opacity:
                              draggedSlideId === index.toString() ? 0.5 : 1,
                          ...
                          >
                            ...
                            >
                              ...
                              <Box sx={{ flex: 1 }}>
                                <Typography
                                  variant="h6"
                                  sx={{ color: slideColor, fontWeight: 600 }}
                                >
                                  Slide {index + 1}
                                </Typography>
                                <Box sx={{ display: "flex", gap: 1, mt: 0.5 }}>
                                  <Chip
                                    ...
                                    color={
                                      slide.isActive ? "success" : "default"
                                    }
                                    variant="outlined"
                                  />
                                  {isCompleted && (
                                    ...
                                    <Box>
                                      ...
                                      {[0, 1, 2].map((lineIndex) => (
                                        <TextField
                                          ...
                                          error={
                                            lineIndex === 0 &&
                                            !slide.titleLines[lineIndex]?.trim()
                                          }
                                          helperText={
                                            lineIndex === 0 &&
                                            !slide.titleLines[lineIndex]?.trim()
                                              ? "At least one title line is required"
                                              : ""
                                          }
                                        />
                                      ))}
            ...
            <Stack spacing={2} sx={{ width: "25%" }}>
                  ...
                  <Grid container spacing={4}>
                    <Grid sx={{ xs: 12, md: 4 }}>
                      <TextField
                        ...
                        InputProps={{
                          startAdornment: (
                            <SpeedIcon sx={{ color: "action.active", mr: 1 }} />
                          ),
                        }}
                      />
                    </Grid>
              ...
              {/* {slides.length > 0 && (
                ...
                >
                  ...
                  {activeSlides > 0 &&
                    completedSlides === 0 &&
                    "⚠️ Complete at least one slide with title and description"}
                  {activeSlides > 0 &&
                    completedSlides > 0 &&
                    `✅ Ready to save: ${completedSlides} completed slide${completedSlides !== 1 ? "s" : ""} out of ${slides.length}`}
                </Alert>
              )} */}
        ...
        >
          ...
          <DialogContent>
            <Typography>
              ...
              <strong>Slide {(deleteDialog.slideIndex ?? -1) + 1}</strong>? This
              action cannot be undone.
            </Typography>
          </DialogContent>
          <DialogActions>
            <Button
              onClick={() => setDeleteDialog({ open: false, slideIndex: null })}
            >
              Cancel
            </Button>
            <Button
              onClick={() =>
                deleteDialog.slideIndex !== null &&
                removeSlide(deleteDialog.slideIndex)
              }
              color="error"
              variant="contained"
            >
