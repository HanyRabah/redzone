      ...
      <Box component="form" onSubmit={handleSubmit}>
        <DialogContent sx={{ p: 0 }}>
          <Stack spacing={4}>
            ...
            {/* Basic Information */}
            <Paper
              sx={{ p: 3, borderRadius: 2, bgcolor: alpha("#1976d2", 0.02) }}
            >
              <Typography
                variant="subtitle1"
                gutterBottom
            ...
            {/* Image Upload */}
            <Paper
              sx={{ p: 3, borderRadius: 2, bgcolor: alpha("#2e7d32", 0.02) }}
            >
              <Typography
                variant="subtitle1"
                gutterBottom
            ...
            {/* Settings */}
            <Paper
              sx={{ p: 3, borderRadius: 2, bgcolor: alpha("#ed6c02", 0.02) }}
            >
              <Typography
                variant="subtitle1"
                gutterBottom
        ...
        <DialogActions sx={{ p: 3, pt: 2 }}>
          ...
          <Button
            ...
            variant="contained"
            disabled={
              isLoading || !formData.name.trim() || !formData.designation.trim()
            }
            startIcon={
  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await fetch(
        `/api/admin/team-members/${deleteDialog.member.id}`,
        {
          method: "DELETE",
        }
      );
        ...
        title={
          <Box sx={{ m: 1 }}>
            ...
            <Typography variant="caption" sx={{ color: "text.secondary" }}>
              Configure team section with title, description, and extras
            </Typography>
          </Box>
        }
      />
      ...
      >
        ...
        <DialogContent>
          <Typography>
            ...
            <strong>{deleteDialog.member?.name}</strong>? This action cannot be
            undone.
          </Typography>
        </DialogContent>
        <DialogActions>
