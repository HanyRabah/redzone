...
export default function WeAreCreativeSectionForm({
  initialData,
}: WeAreCreativeSectionFormProps) {
        ...
        title={
          <Box sx={{ m: 1 }}>
            <Typography variant="h4" sx={{ fontWeight: 600 }}>
              {" "}
              We Are Creative Section{" "}
            </Typography>
            <Typography variant="caption" sx={{ color: "text.secondary" }}>
              Configure we are creative section with title, description, and
              extras
            </Typography>
          </Box>
        }
