...
const lineVariants = {
  closed: { scaleX: 0, transformOrigin: 'right' },
  open: { scaleX: 1, transformOrigin: 'right' }
};
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            setIsDarkMode(entry.target.getAttribute('data-dark-section') === 'true');
          }
        });
      },
      { threshold: 0.5 }
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                initial="closed"
                animate="open"
                transition={{ duration: 1, delay: 1.1, ease: [0.767, 0.01, 0.18, 1.01] }}
